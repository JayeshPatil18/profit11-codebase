                                                  ...
                                                  Expanded(
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        ...
                                                        SizedBox(height: 10),
                                                        replyOfPoster.text.isEmpty ? SizedBox() : AutoSizeText.rich(
                                                          CustomRichText.buildTextSpan(replyOfPoster.text.split(RegExp(r'(?<=\s|\n)')), MainFonts.postMainText(size: 16), MainFonts.postMainText(size: 16, color: AppColors.secondaryColor10)),
                                                          ...
                                                          overflowReplacement: Column(
                                                            ...
                                                            children: <Widget>[
                                                              CustomRichText(
                                                                  wordsList: replyOfPoster.text.split(RegExp(r'(?<=\s|\n)')),
                                                                  maxLines: maxLines,
